  ...
  async initDefaultGoods() {
    if (await this.goodsModel.count() === 0) {
      await this.batchCreateGoods([
        ...
        {name: "QQ音乐三天绿钻体验卡",avatarPath:"http://127.0.0.1:7001/pictures/qqmusic.png"},
        {name: "bilibili大会员年卡",avatarPath:"http://127.0.0.1:7001/pictures/bilibilicard.png"},
        {name: "百度网盘不限速体验卡*50",avatarPath:"http://127.0.0.1:7001/pictures/baidudisk.png"},
        {name: "三国杀移动版66宝珠兑换码",avatarPath:"http://127.0.0.1:7001/pictures/sgs66.png"},
        {name: "京东200元礼品卡",avatarPath:"http://127.0.0.1:7001/pictures/giftcard.png"},
        {name: "腾讯视频会员三折券",avatarPath:"http://127.0.0.1:7001/pictures/tencenttv.png"},
        {name: "QQ音乐一天绿钻体验卡",avatarPath:"http://127.0.0.1:7001/pictures/qqmusic.png"},
        {name: "QQ音乐绿钻月卡",avatarPath:"http://127.0.0.1:7001/pictures/qqmusic.png"},
        {name: "原神1288原石兑换码",avatarPath:"http://127.0.0.1:7001/pictures/yuanshi.png"},
        {name: "王者荣耀随机皮肤体验券*50",avatarPath:"http://127.0.0.1:7001/pictures/wzry.png"},
        {name: "火影忍者手游神秘道具",avatarPath:"http://127.0.0.1:7001/pictures/hyrz.png"},
        {name: "星穹铁道神秘道具",avatarPath:"http://127.0.0.1:7001/pictures/xqtd.png"},
        {name: "QQ音乐绿钻月卡",avatarPath:"http://127.0.0.1:7001/pictures/qqmusic.png"},
        {name: "腾讯视频月卡",avatarPath:"http://127.0.0.1:7001/pictures/tencenttv.png"},
        {name: "优酷视频月卡",avatarPath:"http://127.0.0.1:7001/pictures/youkutv.png"},
      ]);
